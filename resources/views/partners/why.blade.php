            ...
            <form>
                <div class="row mt-5">
                    <div class="form-group col-6">
                        ...
                        <input type="text"
                               class="form-control rounded-0 border-top-0 border-left-0 border-right-0 border-bottom"
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="text"
                               class="form-control  rounded-0 border-top-0 border-left-0 border-right-0 border-bottom"
                               id="exampleInputEmail1" placeholder="+7 ">
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="form-group col-12">
                        ...
                        <textarea
                                class="form-control  rounded-0 border-top-0 border-left-0 border-right-0 border-bottom"
                                id="textarea1" placeholder="Введите текст " rows="3"></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
