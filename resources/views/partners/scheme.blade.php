...
<div class="container-fluid my-padding mb-5">
    ...
    <div class="row ml-0 mr-0 mt-5">
        <div class="col-md-3 pl-0">
            <div class="nav-left-vacancy p-0">
                <ul class="pl-0">
                  ...
                  <li class="pb-3"><a class="active" href="{{ route('partners_scheme') }}">Схема работы</a></li>
        ...
        <div class="col-md-9 pl-4">
            <div class="row">
                <h2 class="text-uppercase cap30 mb-5">СХЕМА РАБОТЫ</h2>
            </div>
            <div class="row">
                <div class="col-md-8">
                    <div class="scheme-div image01">
                      <p class="cap16">Идейные соображения высшего порядка, а также сложившаяся структура организации позволяет выполнять важные задания 
                      по разработке модели развития. </p>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="scheme-div image02">
                      <p class="cap16">Идейные соображения высшего порядка, а также сложившаяся структура организации позволяет выполнять важные задания 
                      по разработке модели развития. </p>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="scheme-div image03">
                      <p class="cap16">Идейные соображения высшего порядка, а также сложившаяся структура организации позволяет выполнять важные задания 
                      по разработке модели развития. </p>
                    </div>
                </div>
