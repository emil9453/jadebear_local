@extends('layouts.app')
@section('title', 'Благодарственные письма')
        ...
        <div class="col-md-3 pl-0">
            <div class="nav-left-vacancy p-0">
                <ul class="pl-0">
                  ...
                  <li class="pb-3"><a class="active" href="{{ route('partners_thanks') }}">Благодарственные письма</a></li>
                </ul>
            </div>
        </div>
        <div class="col-md-9 pl-4">
            <div class="row">
                <h2 class="text-uppercase cap30">Благодарственные письма</h2>
            </div>
            <div class="row mt-4">
                <div class="col-md-4 thanks">
                  <img class="mb-3" src="{{ asset('img/thanks.png') }}">
                  <b class="cap20">Билл Гейтс</b>
                  <div class="hover">
                  </div>
                  <a href="" class="btn my-btn-yellow">Посмотреть</a>
                </div>
                <div class="col-md-4 thanks">
                  <img class="mb-3" src="{{ asset('img/thanks.png') }}">
                  <b class="cap20">Билл Гейтс</b>
