@extends('layouts.app')
@section('title', 'История взаимоотношений')
...
<div class="container-fluid my-padding mb-5">
    ...
    <div class="row ml-0 mr-0 mt-5">
        <div class="col-md-3 pl-0">
            <div class="nav-left-vacancy p-0">
                <ul class="pl-0">
                  ...
                  <li class="pb-3"><a class="active" href="{{ route('partners_relationship') }}">История взаимоотношений</a></li>
        ...
        <div class="col-md-9 pl-4">
            <div class="row">
                <h2 class="text-uppercase cap30 mb-5">История взаимоотношений</h2>
            </div>
            <div class="chart w-100">
              <img src="{{ asset('img/time_horizontal.png') }}">
            </div>
            <div class="row mt-5">
